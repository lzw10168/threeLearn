  ...
  useEffect(() => {
    ...
    const tick = () => {
      ...
      if (mixer) {
        ...
        (animationFolder.children[0] as dat.Controller).disable(
          surveyWeight !== 1,
        );
        (animationFolder.children[1] as dat.Controller).disable(
          walkWeight !== 1,
        );
        (animationFolder.children[2] as dat.Controller).disable(
          runWeight !== 1,
        );
        (animationFolder.children[3] as dat.Controller).disable(
          walkWeight !== 1,
        );
      }
